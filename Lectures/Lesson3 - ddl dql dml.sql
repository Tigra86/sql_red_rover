...
-- Datatypes (string, numeric, date)
-- string data types are    CHAR, VARCHAR, BINARY, VARBINARY, BLOB, TEXT, ENUM, SET
-- numeric data types are   INTEGER, INT, SMALLINT, TINYINT, MEDIUMINT, BIGINT, DECIMAL, NUMERIC, FLOAT, DOUBLE, BIT
-- date data types are      DATE, DATETIME, TIMESTAMP

-- let's create practice database mywork and table mywork.EMPLOYEE_TEST  
